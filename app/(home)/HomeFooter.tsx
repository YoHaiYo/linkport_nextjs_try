            ...
            <form action="">
              <div className="gird-cols-1 grid items-center justify-center gap-4 md:grid-cols-3">
                ...
                >
                  <input
                    type="email"
                    className="peer block min-h-[auto] w-full rounded border border-gray-400 focus:border-purple-500 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary data-[twe-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-white dark:placeholder:text-neutral-300 dark:autofill:shadow-autofill dark:peer-focus:text-primary [&:not([data-twe-input-placeholder-active])]:placeholder:opacity-0"
          ...
          <div className="mb-6 flex justify-center">
            <ul className="text-left">
              <li className="flex flex-col flex-wrap">
                ...
                <a className="truncate" href="https://linkport-nextjs-try.vercel.app/" target="_blank">
              ...
              <li className="flex flex-col flex-wrap">
                ...
                <a className="truncate" href="https://vercel.com/" target="_blank">
                  https://vercel.com/
                </a>
              </li>
              <li className="flex flex-col flex-wrap">
                <b className="mr-1">Supabase</b>
                <a className="truncate" href="https://supabase.com/" target="_blank">
                  https://supabase.com/
                </a>
              </li>
            </ul>
