...
export const HamburgerBtn = () => {
  ...
  return (
    <>
      ...
      {/* <div className={"hidden" + "navbar-menu fixed top-0 left-0 z-50 w-full h-full bg-coolGray-900 bg-opacity-50"}> */}
      <div className={`${visible ? "" : "hidden"} navbar-menu fixed top-0 left-0 z-50 w-full h-full bg-coolGray-900 bg-opacity-50`}>
        <div className="fixed top-0 left-0 bottom-0 w-full w-4/6 max-w-xs bg-white">
          <nav className="border relative p-6 h-full overflow-y-auto">
          ...
          {/* 닫기버튼 */}
          <a
            onClick={() => { setVisible(!visible) }} className="navbar-close absolute top-5 p-4 right-3" href="#">
            <svg
              width={12}
              height={12}
              viewBox="0 0 12 12"
